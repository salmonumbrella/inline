...
class ClientMessage$Type extends MessageType<ClientMessage> {
  ...
  create(value?: PartialMessage<ClientMessage>): ClientMessage {
    ...
    if (value !== undefined) reflectionMergePartial<ClientMessage>(this, message, value)
    return message
  }
  internalBinaryRead(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ConnectionInit connection_init */ 4:
          message.body = {
            oneofKind: "connectionInit",
            connectionInit: ConnectionInit.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.body as any).connectionInit,
            ),
          }
          break
  ...
  internalBinaryWrite(message: ClientMessage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.body.oneofKind === "connectionInit")
      ConnectionInit.internalBinaryWrite(
        message.body.connectionInit,
...
class ConnectionInit$Type extends MessageType<ConnectionInit> {
  constructor() {
    super("ConnectionInit", [{ no: 1, name: "token", kind: "scalar", T: 9 /*ScalarType.STRING*/ }])
  }
  create(value?: PartialMessage<ConnectionInit>): ConnectionInit {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.token = ""
    if (value !== undefined) reflectionMergePartial<ConnectionInit>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class ServerProtocolMessage$Type extends MessageType<ServerProtocolMessage> {
  ...
  create(value?: PartialMessage<ServerProtocolMessage>): ServerProtocolMessage {
    ...
    message.id = 0n
    message.body = { oneofKind: undefined }
    if (value !== undefined) reflectionMergePartial<ServerProtocolMessage>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ConnectionOpen connection_open */ 4:
          message.body = {
            oneofKind: "connectionOpen",
            connectionOpen: ConnectionOpen.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.body as any).connectionOpen,
            ),
          }
          break
  ...
  internalBinaryWrite(
    ...
    if (message.body.oneofKind === "connectionOpen")
      ConnectionOpen.internalBinaryWrite(
        message.body.connectionOpen,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join()
    /* RpcResult rpc_result = 5; */
    if (message.body.oneofKind === "rpcResult")
      RpcResult.internalBinaryWrite(
        message.body.rpcResult,
        writer.tag(5, WireType.LengthDelimited).fork(),
        options,
      ).join()
    /* RpcError rpc_error = 6; */
    if (message.body.oneofKind === "rpcError")
      RpcError.internalBinaryWrite(
        message.body.rpcError,
        writer.tag(6, WireType.LengthDelimited).fork(),
        options,
      ).join()
    /* ServerMessage message = 7; */
    if (message.body.oneofKind === "message")
      ServerMessage.internalBinaryWrite(
...
class ServerMessage$Type extends MessageType<ServerMessage> {
  constructor() {
    super("ServerMessage", [{ no: 4, name: "update", kind: "message", oneof: "payload", T: () => UpdatesPayload }])
  }
  create(value?: PartialMessage<ServerMessage>): ServerMessage {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.payload = { oneofKind: undefined }
    if (value !== undefined) reflectionMergePartial<ServerMessage>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* UpdatesPayload update */ 4:
          message.payload = {
            oneofKind: "update",
            update: UpdatesPayload.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.payload as any).update,
            ),
          }
          break
        default:
  ...
  internalBinaryWrite(message: ServerMessage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.payload.oneofKind === "update")
      UpdatesPayload.internalBinaryWrite(
...
class UpdatesPayload$Type extends MessageType<UpdatesPayload> {
  ...
  create(value?: PartialMessage<UpdatesPayload>): UpdatesPayload {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.updates = []
    if (value !== undefined) reflectionMergePartial<UpdatesPayload>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Ack$Type extends MessageType<Ack> {
  constructor() {
    super("Ack", [{ no: 1, name: "msg_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }])
  }
  create(value?: PartialMessage<Ack>): Ack {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.msgId = 0n
    if (value !== undefined) reflectionMergePartial<Ack>(this, message, value)
    return message
  }
  ...
  internalBinaryWrite(message: Ack, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* uint64 msg_id = 1; */
    if (message.msgId !== 0n) writer.tag(1, WireType.Varint).uint64(message.msgId)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class ConnectionOpen$Type extends MessageType<ConnectionOpen> {
  ...
  create(value?: PartialMessage<ConnectionOpen>): ConnectionOpen {
    const message = globalThis.Object.create(this.messagePrototype!)
    if (value !== undefined) reflectionMergePartial<ConnectionOpen>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Ping$Type extends MessageType<Ping> {
  constructor() {
    super("Ping", [{ no: 1, name: "nonce", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }])
  }
  ...
  internalBinaryWrite(message: Ping, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* uint64 nonce = 1; */
    if (message.nonce !== 0n) writer.tag(1, WireType.Varint).uint64(message.nonce)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class Pong$Type extends MessageType<Pong> {
  constructor() {
    super("Pong", [{ no: 1, name: "nonce", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }])
  }
  create(value?: PartialMessage<Pong>): Pong {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.nonce = 0n
    if (value !== undefined) reflectionMergePartial<Pong>(this, message, value)
    return message
  }
...
class InputPeer$Type extends MessageType<InputPeer> {
  ...
  create(value?: PartialMessage<InputPeer>): InputPeer {
    ...
    if (value !== undefined) reflectionMergePartial<InputPeer>(this, message, value)
    return message
  }
  ...
  internalBinaryWrite(message: InputPeer, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.type.oneofKind === "self")
      InputPeerSelf.internalBinaryWrite(
        message.type.self,
    ...
    if (message.type.oneofKind === "chat")
      InputPeerChat.internalBinaryWrite(
        message.type.chat,
    ...
    if (message.type.oneofKind === "user")
      InputPeerUser.internalBinaryWrite(
        message.type.user,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
class InputPeerSelf$Type extends MessageType<InputPeerSelf> {
  ...
  create(value?: PartialMessage<InputPeerSelf>): InputPeerSelf {
    const message = globalThis.Object.create(this.messagePrototype!)
    if (value !== undefined) reflectionMergePartial<InputPeerSelf>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class InputPeerChat$Type extends MessageType<InputPeerChat> {
  ...
  create(value?: PartialMessage<InputPeerChat>): InputPeerChat {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.chatId = 0n
    if (value !== undefined) reflectionMergePartial<InputPeerChat>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: InputPeerChat, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* int64 chat_id = 1; */
    if (message.chatId !== 0n) writer.tag(1, WireType.Varint).int64(message.chatId)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class InputPeerUser$Type extends MessageType<InputPeerUser> {
  ...
  create(value?: PartialMessage<InputPeerUser>): InputPeerUser {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.userId = 0n
    if (value !== undefined) reflectionMergePartial<InputPeerUser>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: InputPeerUser, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* int64 user_id = 1; */
    if (message.userId !== 0n) writer.tag(1, WireType.Varint).int64(message.userId)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class Peer$Type extends MessageType<Peer> {
  ...
  create(value?: PartialMessage<Peer>): Peer {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.type = { oneofKind: undefined }
    if (value !== undefined) reflectionMergePartial<Peer>(this, message, value)
    return message
  }
...
class PeerChat$Type extends MessageType<PeerChat> {
  constructor() {
    super("PeerChat", [{ no: 1, name: "chat_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }])
  }
  create(value?: PartialMessage<PeerChat>): PeerChat {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.chatId = 0n
    if (value !== undefined) reflectionMergePartial<PeerChat>(this, message, value)
    return message
  }
...
class PeerUser$Type extends MessageType<PeerUser> {
  constructor() {
    super("PeerUser", [{ no: 1, name: "user_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }])
  }
  create(value?: PartialMessage<PeerUser>): PeerUser {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.userId = 0n
    if (value !== undefined) reflectionMergePartial<PeerUser>(this, message, value)
    return message
  }
...
class User$Type extends MessageType<User> {
  ...
  internalBinaryWrite(message: User, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.firstName !== undefined) writer.tag(2, WireType.LengthDelimited).string(message.firstName)
    /* optional string last_name = 3; */
    if (message.lastName !== undefined) writer.tag(3, WireType.LengthDelimited).string(message.lastName)
    /* optional string username = 4; */
    if (message.username !== undefined) writer.tag(4, WireType.LengthDelimited).string(message.username)
    /* optional string phone_number = 5; */
    if (message.phoneNumber !== undefined) writer.tag(5, WireType.LengthDelimited).string(message.phoneNumber)
    /* optional string email = 6; */
    if (message.email !== undefined) writer.tag(6, WireType.LengthDelimited).string(message.email)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class Message$Type extends MessageType<Message> {
  ...
  internalBinaryWrite(message: Message, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.id !== 0n) writer.tag(1, WireType.Varint).int64(message.id)
    /* int64 from_id = 2; */
    if (message.fromId !== 0n) writer.tag(2, WireType.Varint).int64(message.fromId)
    /* Peer peer_id = 3; */
    if (message.peerId)
      Peer.internalBinaryWrite(message.peerId, writer.tag(3, WireType.LengthDelimited).fork(), options).join()
    /* int64 chat_id = 4; */
    if (message.chatId !== 0n) writer.tag(4, WireType.Varint).int64(message.chatId)
    /* optional string message = 5; */
    if (message.message !== undefined) writer.tag(5, WireType.LengthDelimited).string(message.message)
    /* bool out = 6; */
    if (message.out !== false) writer.tag(6, WireType.Varint).bool(message.out)
    /* int64 date = 7; */
    if (message.date !== 0n) writer.tag(7, WireType.Varint).int64(message.date)
    /* optional bool mentioned = 8; */
    if (message.mentioned !== undefined) writer.tag(8, WireType.Varint).bool(message.mentioned)
    /* optional int64 reply_to_msg_id = 9; */
    if (message.replyToMsgId !== undefined) writer.tag(9, WireType.Varint).int64(message.replyToMsgId)
    ...
    if (message.editDate !== undefined) writer.tag(11, WireType.Varint).int64(message.editDate)
    /* optional int64 grouped_id = 12; */
    if (message.groupedId !== undefined) writer.tag(12, WireType.Varint).int64(message.groupedId)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class MessageMedia$Type extends MessageType<MessageMedia> {
  constructor() {
    super("MessageMedia", [{ no: 1, name: "photo", kind: "message", oneof: "media", T: () => MessagePhoto }])
  }
  create(value?: PartialMessage<MessageMedia>): MessageMedia {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.media = { oneofKind: undefined }
    if (value !== undefined) reflectionMergePartial<MessageMedia>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: MessageMedia, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.media.oneofKind === "photo")
      MessagePhoto.internalBinaryWrite(
        message.media.photo,
...
class MessagePhoto$Type extends MessageType<MessagePhoto> {
  constructor() {
    super("MessagePhoto", [{ no: 1, name: "photo", kind: "message", T: () => Photo }])
  }
  create(value?: PartialMessage<MessagePhoto>): MessagePhoto {
    const message = globalThis.Object.create(this.messagePrototype!)
    if (value !== undefined) reflectionMergePartial<MessagePhoto>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Photo$Type extends MessageType<Photo> {
  ...
  create(value?: PartialMessage<Photo>): Photo {
    ...
    if (value !== undefined) reflectionMergePartial<Photo>(this, message, value)
    return message
  }
  ...
  internalBinaryWrite(message: Photo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.id !== 0n) writer.tag(1, WireType.Varint).int64(message.id)
    /* int64 date = 2; */
    if (message.date !== 0n) writer.tag(2, WireType.Varint).int64(message.date)
    ...
    if (message.format !== 0) writer.tag(4, WireType.Varint).int32(message.format)
    /* string file_unique_id = 100; */
    if (message.fileUniqueId !== "") writer.tag(100, WireType.LengthDelimited).string(message.fileUniqueId)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class PhotoSize$Type extends MessageType<PhotoSize> {
  ...
  create(value?: PartialMessage<PhotoSize>): PhotoSize {
    ...
    message.h = 0
    message.size = 0
    if (value !== undefined) reflectionMergePartial<PhotoSize>(this, message, value)
    return message
  }
  ...
  internalBinaryWrite(message: PhotoSize, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* int32 w = 2; */
    if (message.w !== 0) writer.tag(2, WireType.Varint).int32(message.w)
    /* int32 h = 3; */
    if (message.h !== 0) writer.tag(3, WireType.Varint).int32(message.h)
    /* int32 size = 4; */
    if (message.size !== 0) writer.tag(4, WireType.Varint).int32(message.size)
    /* optional bytes bytes = 5; */
    if (message.bytes !== undefined) writer.tag(5, WireType.LengthDelimited).bytes(message.bytes)
    /* optional string cdn_url = 6; */
    if (message.cdnUrl !== undefined) writer.tag(6, WireType.LengthDelimited).string(message.cdnUrl)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class RpcError$Type extends MessageType<RpcError> {
  ...
  internalBinaryWrite(message: RpcError, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* uint64 req_msg_id = 1; */
    if (message.reqMsgId !== 0n) writer.tag(1, WireType.Varint).uint64(message.reqMsgId)
...
class RpcCall$Type extends MessageType<RpcCall> {
  ...
  create(value?: PartialMessage<RpcCall>): RpcCall {
    ...
    if (value !== undefined) reflectionMergePartial<RpcCall>(this, message, value)
    return message
  }
  ...
  internalBinaryWrite(message: RpcCall, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* Method method = 1; */
    if (message.method !== 0) writer.tag(1, WireType.Varint).int32(message.method)
    /* GetMeInput getMe = 2; */
    if (message.input.oneofKind === "getMe")
      GetMeInput.internalBinaryWrite(
        message.input.getMe,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
class RpcResult$Type extends MessageType<RpcResult> {
  ...
  create(value?: PartialMessage<RpcResult>): RpcResult {
    ...
    if (value !== undefined) reflectionMergePartial<RpcResult>(this, message, value)
    return message
  }
  ...
  internalBinaryWrite(message: RpcResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.result.oneofKind === "getMe")
      GetMeResult.internalBinaryWrite(
        message.result.getMe,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
    let u = options.writeUnknownFields
...
class GetMeInput$Type extends MessageType<GetMeInput> {
  ...
  create(value?: PartialMessage<GetMeInput>): GetMeInput {
    const message = globalThis.Object.create(this.messagePrototype!)
    if (value !== undefined) reflectionMergePartial<GetMeInput>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class GetMeResult$Type extends MessageType<GetMeResult> {
  constructor() {
    super("GetMeResult", [{ no: 1, name: "user", kind: "message", T: () => User }])
  }
  create(value?: PartialMessage<GetMeResult>): GetMeResult {
    const message = globalThis.Object.create(this.messagePrototype!)
    if (value !== undefined) reflectionMergePartial<GetMeResult>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Update$Type extends MessageType<Update> {
  ...
  create(value?: PartialMessage<Update>): Update {
    ...
    if (value !== undefined) reflectionMergePartial<Update>(this, message, value)
    return message
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* UpdateNewMessage new_message */ 4:
          message.update = {
            oneofKind: "newMessage",
            newMessage: UpdateNewMessage.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.update as any).newMessage,
            ),
          }
          break
        case /* UpdateEditMessage edit_message */ 5:
          message.update = {
            oneofKind: "editMessage",
            editMessage: UpdateEditMessage.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.update as any).editMessage,
            ),
          }
          break
        case /* UpdateMessageId update_message_id */ 6:
          message.update = {
            oneofKind: "updateMessageId",
            updateMessageId: UpdateMessageId.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.update as any).updateMessageId,
            ),
          }
          break
        case /* UpdateDeleteMessages delete_messages */ 7:
          message.update = {
            oneofKind: "deleteMessages",
            deleteMessages: UpdateDeleteMessages.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.update as any).deleteMessages,
            ),
          }
          break
        case /* UpdateComposeAction update_compose_action */ 8:
          message.update = {
            oneofKind: "updateComposeAction",
            updateComposeAction: UpdateComposeAction.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.update as any).updateComposeAction,
            ),
          }
          break
        case /* UpdateUserStatus update_user_status */ 9:
          message.update = {
            oneofKind: "updateUserStatus",
            updateUserStatus: UpdateUserStatus.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.update as any).updateUserStatus,
            ),
          }
          break
        default:
  ...
  internalBinaryWrite(message: Update, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.update.oneofKind === "newMessage")
      UpdateNewMessage.internalBinaryWrite(
    ...
    if (message.update.oneofKind === "editMessage")
      UpdateEditMessage.internalBinaryWrite(
    ...
    if (message.update.oneofKind === "updateMessageId")
      UpdateMessageId.internalBinaryWrite(
        message.update.updateMessageId,
        writer.tag(6, WireType.LengthDelimited).fork(),
        options,
      ).join()
    /* UpdateDeleteMessages delete_messages = 7; */
    if (message.update.oneofKind === "deleteMessages")
      UpdateDeleteMessages.internalBinaryWrite(
        message.update.deleteMessages,
        writer.tag(7, WireType.LengthDelimited).fork(),
        options,
      ).join()
    /* UpdateComposeAction update_compose_action = 8; */
    if (message.update.oneofKind === "updateComposeAction")
      UpdateComposeAction.internalBinaryWrite(
        message.update.updateComposeAction,
        writer.tag(8, WireType.LengthDelimited).fork(),
        options,
      ).join()
    /* UpdateUserStatus update_user_status = 9; */
    if (message.update.oneofKind === "updateUserStatus")
      UpdateUserStatus.internalBinaryWrite(
        message.update.updateUserStatus,
...
class UpdateNewMessage$Type extends MessageType<UpdateNewMessage> {
  constructor() {
    super("UpdateNewMessage", [{ no: 1, name: "message", kind: "message", T: () => Message }])
  }
  create(value?: PartialMessage<UpdateNewMessage>): UpdateNewMessage {
    const message = globalThis.Object.create(this.messagePrototype!)
    if (value !== undefined) reflectionMergePartial<UpdateNewMessage>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class UpdateEditMessage$Type extends MessageType<UpdateEditMessage> {
  constructor() {
    super("UpdateEditMessage", [{ no: 1, name: "message", kind: "message", T: () => Message }])
  }
  create(value?: PartialMessage<UpdateEditMessage>): UpdateEditMessage {
    const message = globalThis.Object.create(this.messagePrototype!)
    if (value !== undefined) reflectionMergePartial<UpdateEditMessage>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class UpdateDeleteMessages$Type extends MessageType<UpdateDeleteMessages> {
  ...
  create(value?: PartialMessage<UpdateDeleteMessages>): UpdateDeleteMessages {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.messageIds = []
    if (value !== undefined) reflectionMergePartial<UpdateDeleteMessages>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated int64 message_ids */ 1:
          ...
          else message.messageIds.push(reader.int64().toBigInt())
          break
        case /* Peer peer_id */ 2:
          message.peerId = Peer.internalBinaryRead(reader, reader.uint32(), options, message.peerId)
          break
  ...
  internalBinaryWrite(
    ...
    if (message.messageIds.length) {
      writer.tag(1, WireType.LengthDelimited).fork()
      for (let i = 0; i < message.messageIds.length; i++) writer.int64(message.messageIds[i])
      writer.join()
    }
    /* Peer peer_id = 2; */
    if (message.peerId)
...
class UpdateMessageId$Type extends MessageType<UpdateMessageId> {
  ...
  create(value?: PartialMessage<UpdateMessageId>): UpdateMessageId {
    ...
    message.randomId = 0n
    if (value !== undefined) reflectionMergePartial<UpdateMessageId>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: UpdateMessageId, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* int64 message_id = 1; */
    if (message.messageId !== 0n) writer.tag(1, WireType.Varint).int64(message.messageId)
    /* int64 random_id = 2; */
    if (message.randomId !== 0n) writer.tag(2, WireType.Varint).int64(message.randomId)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class UpdateComposeAction$Type extends MessageType<UpdateComposeAction> {
  constructor() {
    super("UpdateComposeAction", [
      ...
      { no: 2, name: "peer_id", kind: "message", T: () => Peer },
      {
        ...
        name: "action",
        kind: "enum",
        T: () => ["UpdateComposeAction.ComposeAction", UpdateComposeAction_ComposeAction],
      },
    ])
  }
  create(value?: PartialMessage<UpdateComposeAction>): UpdateComposeAction {
    ...
    message.userId = 0n
    message.action = 0
    if (value !== undefined) reflectionMergePartial<UpdateComposeAction>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: UpdateComposeAction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.action !== 0) writer.tag(3, WireType.Varint).int32(message.action)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class UpdateUserStatus$Type extends MessageType<UpdateUserStatus> {
  ...
  create(value?: PartialMessage<UpdateUserStatus>): UpdateUserStatus {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.userId = 0n
    if (value !== undefined) reflectionMergePartial<UpdateUserStatus>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class UserStatus$Type extends MessageType<UserStatus> {
  ...
  create(value?: PartialMessage<UserStatus>): UserStatus {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.online = 0
    if (value !== undefined) reflectionMergePartial<UserStatus>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: UserStatus, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.online !== 0) writer.tag(1, WireType.Varint).int32(message.online)
...
class LastOnline$Type extends MessageType<LastOnline> {
  ...
  create(value?: PartialMessage<LastOnline>): LastOnline {
    const message = globalThis.Object.create(this.messagePrototype!)
    if (value !== undefined) reflectionMergePartial<LastOnline>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: LastOnline, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.date !== undefined) writer.tag(1, WireType.Varint).int64(message.date)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
