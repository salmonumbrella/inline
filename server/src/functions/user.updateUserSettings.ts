...
export const updateUserSettings = async (
  ...
  let updatedGeneral: UserSettingsGeneralInput | undefined = undefined

  if (input.general) {
    await UserSettingsModel.updateGeneral(context.currentUserId, input.general)
    updatedGeneral = input.general
